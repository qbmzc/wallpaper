...
class MainWindow:
    ...
    def __init__(self):
        ...
        settingmenu.add_command(label="default folder", command=set_file_save_dictionary)
        settingmenu.add_command(label="alean all", command=delete_wallpaper)
        ...
        helpmenu.add_command(label="about", command=about_software_information)
        helpmenu.add_command(label="usage", command=usage_help_information)
        menubar.add_cascade(label="help", menu=helpmenu)

        # 显示菜单
        self.frame.config(menu=menubar)

        self.button1 = Button(self.frame, text="bing", width=15, height=3, bg='DarkOrchid', fg='GhostWhite',
                              relief="flat")
        self.button2 = Button(self.frame, text="gjdl", width=15, height=3, bg='DarkOrchid', fg='GhostWhite',
                              relief="flat")
        self.button3 = Button(self.frame, text="wallheaven", width=15, height=3, bg='DarkOrchid', fg='GhostWhite',
                              relief="flat")
        # 新功能预留
...
def setWallpaper(imagepath):
    sh = "gsettings set org.gnome.desktop.background picture-uri"+imagepath
    os.system(sh)
...
def get_wallheaven_img(html):
    ...
    q = '<meta property="og:image" content="//w.wallhaven.cc/full/.*?" />'
